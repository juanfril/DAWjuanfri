...
CREATE INDEX EMP_APELLIDOS ON empresa.EMP (APELLIDOS);
...
CREATE INDEX CLIENTE_NOMBRE ON empresa.CLIENTE (NOMBRE);
CREATE INDEX CLIENTE_REPR_CLI ON empresa.CLIENTE (REPR_COD, CLIENTE_COD);


INSERT INTO empresa.CLIENTE (CLIENTE_COD, NOMBRE, DIRECCION, CIUDAD, ESTADO, CODIGO_POSTAL, AREA, 
...
CREATE TABLE IF NOT EXISTS empresa.PEDIDO  (
 PED_NUM             SMALLINT(4) UNSIGNED PRIMARY KEY,
 PED_FECHA           DATE,
 PED_TIPO            CHAR (1) CHECK (PED_TIPO IN ('A','B','C')),
...
CREATE INDEX PEDIDO_FECHA_NUM ON empresa.PEDIDO (PED_FECHA,PED_NUM);
CREATE INDEX PEDIDO_FPEDIDO_NUM ON empresa.PEDIDO (FECHA_PEDIDO,PED_NUM);


INSERT INTO empresa.PEDIDO (PED_NUM, PED_FECHA, PED_TIPO, CLIENTE_COD, FECHA_PEDIDO, TOTAL)
...
CREATE TABLE IF NOT EXISTS empresa.DETALLE  (
 PED_NUM             SMALLINT(4) UNSIGNED,
 DETALLE_NUM         SMALLINT(4) UNSIGNED,
 PROD_NUM            INT(6) UNSIGNED NOT NULL,
 PRECIO_VENTA        DECIMAL(8,2) UNSIGNED,
 CANTIDAD            INT (8),
 IMPORTE             DECIMAL(8,2),
 CONSTRAINT DETALLE_PK PRIMARY KEY (PED_NUM,DETALLE_NUM),
 INDEX IDX_DETALLE_PED_NUM (PED_NUM),
 INDEX IDX_PROD_NUM (PROD_NUM),
 FOREIGN KEY (PED_NUM) REFERENCES empresa.PEDIDO(PED_NUM),
 FOREIGN KEY (PROD_NUM) REFERENCES empresa.PRODUCTO(PROD_NUM));


CREATE INDEX DETALLE_PROD_PED_DET ON empresa.DETALLE (PROD_NUM,PED_NUM,DETALLE_NUM);


INSERT INTO empresa.DETALLE (PED_NUM, DETALLE_NUM, PROD_NUM, PRECIO_VENTA, CANTIDAD, IMPORTE)

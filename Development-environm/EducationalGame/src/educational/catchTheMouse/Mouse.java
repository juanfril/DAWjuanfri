...
public class Mouse extends AnimatedSprite {
    ...
    private static final String IMAGE_PATH = "assets/mouse.png";
    ...
    public void move(int movement){
        ...
        if(movement == LEFT)
            ...
            newX += Math.min(STEP, CatchTheMouseScene.GAME_WIDTH - MAIN_CHARACTER_WIDTH - x);
        moveTo(newX, y);
        animate(movement);
    }

    public void resetPosition(){
        moveTo(CatchTheMouseScene.GAME_WIDTH / 2 - MAIN_CHARACTER_WIDTH /2,
                CatchTheMouseScene.GAME_HEIGHT - 30 -MAIN_CHARACTER_HEIGHT);
    }
}
